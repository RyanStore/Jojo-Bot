...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Powered By R- ]')}\n\n${chalk.red('Yann-Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@yann.xd_88')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 822-5228-5143')}\n${chalk.red('Donate')} : ${chalk.white('082350496532 ( Gopay/Pulsa )')}\n`))
}
