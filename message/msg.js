...
//Setting ke 2
const nobot = "622350496532"

// Setting Donasi
const gopay = "0822-5228-5143"
const ovo = "0822-5228-5143"
const dana = "0823-5049-6533"
const pulsa = "0822-5228-5143"
const pulsa2 = "082350496532"
const insta = "yann.xd_88"
const github = "RyanXone"
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const isOwner = ownerNumber == sender ? true : [`${ownerNumber}@s.whatsapp.net`, "6282252285143@s.whatsapp.net"].includes(sender) ? true : false
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `GRUP YANN-BOT`, url : `https://chat.whatsapp.com/FpZUpCuTGTNDhh1mXEgeDJ` } },
			{ urlButton: { displayText: `Nomer Owner`, url : `https://wa.me/6282252285143?text=Bg+mau+beli+PREMIUM` } },
			{ quickReplyButton: { displayText: `💰 Donasi`, id: `${prefix}donate` } },
			{ quickReplyButton: { displayText: `Script`, id: `${prefix}sc` } },
		]
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `0822-5228-5143` } },
			{ urlButton: { displayText: `YANN GROUP`, url : `https://chat.whatsapp.com/FpZUpCuTGTNDhh1mXEgeDJ` } },
		...
		switch(command) {
			...
			case prefix+'help':
			  /*conn.sendMessage(from, { audio: fs.readFileSync('audio/Assalamualaika.m4a'), mimetype: 'audio/mp4', ptt: true}, {quoted: msg})*/
				...
				/*conn.sendMessage(from, { react: { text: `👋`, key: msg.key }})*/
conn.sendMessage(from, { caption: teks, image: fs.readFileSync('media/Jojo2.jpg'), templateButtons: buttonsDefault, footer: '© Yann - Bot', mentions: [sender]} )
				break
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `YANNBOT GC`, url : `https://chat.whatsapp.com/FpZUpCuTGTNDhh1mXEgeDJ` } },
...
var teks = `  │
 ...
 conn.sendMessage(from, { caption: teks, image: {url: `https://i.ibb.co/CPcFJ6c/IMG-20220131-WA0504.jpg`}, templateButtons: donasibut, footer: '© Yann - Bot', mentions: [sender]} )  
			    break
case prefix+'sewa':
...
*LIST DAFTAR PREMIUM*
- Rp.15.000 - PERMANENT`
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync('media/Jojo2.jpg') }, templateButtons: button5, footer: '© Yann - Bot', mentions: [sender] })
			    break
			case prefix+'runtime':
			    reply(runtime(process.uptime()))
			    break
case prefix+'yangrup':
  reply("Group 1\n\nhttps://chat.whatsapp.com/FpZUpCuTGTNDhh1mXEgeDJ")
  break
			case prefix+'speed':
			  reply("Testing Speed...")
			    let timestamp = speed();
...
break
  ...
  ├─ ❏ 082252285143
  ├─ ❏ INSTAGRAM
  └─ ❏ https://www.instagram.com/yann.xd_88
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('@s.whatsapp.net')[0], 'Yann', msg)
			    }
		...
		conn.sendMessage(from, {text: `Nyari Owner buat apa?`, templateButtons: owncuy, footer: `My Name : Ryan Aditya Pratama`, mentions: [sender]} )
			    break
case prefix+'igowner':
...
case prefix+'githubown':
 ...
 break
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using YANN-BOT!`, video: {url: data.nowm}, templateButtons: tidtod, footer: '© Yann - Bot', mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
...
case prefix+'bc': case prefix+'broadcast':
			    if (!isOwner) return reply(mess.OnlyOwner)
		            if (args.length < 2) return reply(`Masukkan isi pesannya`)
                            ...
                            for (let i of data) {
                               conn.sendMessage(i.id, { text: `*[ YannBot BROADCAST ]*\n\n${q}` })
                               await sleep(1000)
                            }
                            break
...
case prefix+'n':
  ...
  break
case prefix+'sc':
  reply("https://github.com/ReffDessn")
  break
case prefix+'apakah':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
case prefix+'add':
  if (!isOwner)return reply("_Maaf Fitur Ini Di Nonaktifkan Oleh Owner, Karena menyebabkan nomer bot 3 kali ke banned_")
    ...
    break
            ...
            case prefix+'tf':{
                 if (args.length < 2) return reply(`Kirim perintah *${command}* @tag nominal\nContoh : ${command} @6282252285143 2000`)
...
conn.sendMessage(from, { text: caption, buttons: but, footer: "© yann Bot", templateButtons: but }, {quoted: msg})
limitAdd(sender, limit)
break
//maker arasya
case prefix+'leaves':
...
case prefix+'pornhub':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
  var data = await fetchJson(`https://6282252285143-docsapi.herokuapp.com/api/textpro/porn-hub?apikey=Joo&text1=${args[1]}&text2=${args[2]}`)
  conn.sendMessage(from, {caption: `Succes!`, image: {url: data.result}}, {quoted: msg})
  limitAdd(sender, limit)
  break
case prefix+'3d':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
  var data = await fetchJson(`https://6282252285143-docsapi.herokuapp.com/api/textpro/3d-gradient?apikey=Joo&text=${q}`)
  conn.sendMessage(from, {caption: `Succes!`, image: {url: data.result}}, {quoted: msg})
  limitAdd(sender, limit)
  break
...
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
  var data = await fetchJson(`https://6282252285143-docsapi.herokuapp.com/api/textpro/christmas?apikey=Joo&text=${q}`)
  conn.sendMessage(from, {caption: `Succes!`, image: {url: data.result}}, {quoted: msg})
  limitAdd(sender, limit)
  break
case prefix+'logowolf':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
  var data = await fetchJson(`https://6282252285143-docsapi.herokuapp.com/api/textpro/logo-wolf2?apikey=Joo&text=${args[1]}&text2=${args[2]}`)
...
case prefix+'logowolf2':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
  var data = await fetchJson(`https://6282252285143-docsapi.herokuapp.com/api/textpro/logo-wolf ?apikey=Joo&text=${args[1]}&text2=${args[2]}`)
  conn.sendMessage(from, {caption: `Succes!`, image: {url: data.result}}, {quoted: msg})
  limitAdd(sender, limit)
  break
//Amel
...
var data = await fetchJson(`https://docs-6282252285143.herokuapp.com/api/translate?text=${quoted}&from=${args[1]}&to=${args[2]}`)
